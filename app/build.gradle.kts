...
dependencies {
    ...
    // JVM-side unit tests for the residency policy — run in CI without a
    // device or the model bundle. test-junit so kotlin.test.Test resolves to
    // a concrete framework annotation.
