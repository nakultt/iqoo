...
/**
 * Seed inspection records — mirrors the demo vault in the inspector app's `Repo`
 * so the bot and the app tell the same story for every consignment.
 */
object BotData {
    ...
    fun seed(now: Long): List<InspectionRecord> {
